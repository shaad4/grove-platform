...
class Notification(models.Model):
    ...
    related_request = models.ForeignKey(Request, null=True, blank=True, on_delete=models.SET_NULL, related_name="notifications")
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(fields=["recipient", "is_read"], name="idx_notifi_recipient_unread"),
            models.Index(fields=["tenant", "recipient", "created_at"], name="idx_notifi_feed"),
            models.Index(fields=["event_type"], name="idx_notifications_event_type"),
            models.Index(fields=["related_request"], name="idx_notifications_request_id"),
