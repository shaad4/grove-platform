...
export default function WorkspaceSetupPage() {
  ...
  // Auto-generate clean URL slug from business name string
  useEffect(() => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      // Standard instant redirect on success match layout specification
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div>
              ...
              <div className="mt-2 flex items-center justify-between text-[11px]">
                ...
                {slugStatus === 'taken' && (
                  <p className="font-medium text-red-500 font-medium">URL path taken</p>
                )}
              </div>
